...
const REGULAR = [
  ['f01', 'Dr. Sharmin Rahman', 'DSR', 'Professor & Head', 'Pharmacy'],
  ['f02', 'Dr. Md. Masud Rana', 'DMR', 'Associate Professor', 'Pharmacy'],
  ['f03', 'Dr. Nusrat Hossain Akter', 'NHA', 'Assistant Professor', 'Pharmacy'],
  ['f04', 'Dr. Farhana Akter', 'FMA', 'Associate Professor', 'Pharmacy'],
  ['f05', 'Dr. Sakib Ahmed', 'SAK', 'Assistant Professor', 'Pharmacy'],
  ['f06', 'Dr. Rezaul Alam Bhuiyan', 'RAB', 'Professor', 'Pharmacy'],
  ['f07', 'Dr. Mahmudul Hasan', 'MHH', 'Assistant Professor', 'Pharmacy'],
  ['f08', 'Dr. Tanvir Ahmed Shanto', 'TAS', 'Senior Lecturer', 'Pharmacy'],
  ['f09', 'Dr. Arif Chowdhury', 'ACH', 'Assistant Professor', 'Pharmacy'],
  ['f10', 'Dr. Sharmin Sultana', 'SSS', 'Associate Professor', 'Pharmacy'],
  ['f11', 'Md. Kamrul Islam', 'KIK', 'Senior Lecturer', 'Pharmacy'],
  ['f12', 'Dr. Nazia Islam', 'NIS', 'Assistant Professor', 'Pharmacy'],
  ['f13', 'Dr. Anika Tabassum', 'ATB', 'Assistant Professor', 'Pharmacy'],
  ['f14', 'Dr. Siddhartha Paul', 'SDP', 'Associate Professor', 'Pharmacy'],
  ['f15', 'Dr. Shafina Akter', 'SHA', 'Senior Lecturer', 'Pharmacy'],
  ['f16', 'Dr. Nasrin Sultana', 'NSU', 'Assistant Professor', 'Pharmacy'],
  ['f17', 'Md. Rashedul Karim', 'RKM', 'Lecturer', 'Pharmacy'],
  ['f18', 'Dr. Fahmida Karim', 'FKH', 'Assistant Professor', 'Pharmacy'],
  ['f19', 'Dr. Joynal Abedin', 'JAB', 'Associate Professor', 'Pharmacy'],
  ['f20', 'Dr. Sabrina Haque', 'SBH', 'Assistant Professor', 'Pharmacy'],
  ['f21', 'Dr. Noor Mohammad', 'NMM', 'Senior Lecturer', 'Pharmacy'],
  ['f22', 'Dr. Ayesha Siddika', 'AYS', 'Assistant Professor', 'Pharmacy'],
  ['f23', 'Dr. Touhid Ahmed', 'TAH', 'Associate Professor', 'Pharmacy'],
  ['f24', 'Dr. Mithila Roy', 'MRY', 'Lecturer', 'Pharmacy'],
];

const DEMOS = [
  ['f25', 'Sumaiya Akter', 'SMA', 'Laboratory Instructor', 'Pharmacy'],
  ['f26', 'Rakibul Hasan', 'RKH', 'Laboratory Instructor', 'Pharmacy'],
  ['f27', 'Tanvir Alam', 'TAA', 'Laboratory Instructor', 'Pharmacy'],
  ['f28', 'Sadia Islam', 'SDA', 'Laboratory Instructor', 'Pharmacy'],
  ['f29', 'Mehedi Hasan', 'MHD', 'Laboratory Instructor', 'Pharmacy'],
  ['f30', 'Rima Khatun', 'RMA', 'Laboratory Instructor', 'Pharmacy'],
  ['f31', 'Shahriar Kabir', 'SHK', 'Laboratory Instructor', 'Pharmacy'],
  ['f32', 'Rupa Das', 'RPD', 'Laboratory Instructor', 'Pharmacy'],
];

const GUESTS = [
  ['f33', 'Dr. Abdul Karim Mahmud', 'AKM', 'Guest Faculty (Industry)', 'Pharmacy', 'guest'],
  ['f34', 'Dr. Sultana Farzana Rahman', 'SFR', 'Guest Faculty (Medical)', 'Medicine', 'guest'],
];

const GED = [
  ['f35', 'Kazi Nurul Islam', 'KNI', 'Associate Professor', 'GED', 'ged'],
  ['f36', 'Rasheda Begum', 'RBA', 'Assistant Professor', 'GED', 'ged'],
  ['f37', 'Md. Shafiqul Alam', 'MSA', 'Senior Lecturer', 'GED', 'ged'],
  ['f38', 'Shamima Nasrin', 'SHN', 'Lecturer', 'GED', 'ged'],
];

const NFE = [['f39', 'Ashraful Islam Kaiyum', 'AIK', 'Assistant Professor', 'Non-Formal Education', 'nfe']];

const EXTERNAL = [
  ['f40', 'Dr. Jahid Hasan', 'JHH', 'Professor (Agronomy)', 'Agriculture', 'external'],
  ['f41', 'Dr. Tanzila Kabir', 'TKB', 'Head, External Faculty', 'Agriculture', 'external'],
];

const FACULTY = [
  ...REGULAR.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: 'regular' })),
  ...DEMOS.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: 'regular' })),
  ...GUESTS.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: r[5] })),
  ...GED.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: r[5] })),
  ...NFE.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: r[5] })),
  ...EXTERNAL.map((r) => ({ id: r[0], name: r[1], initials: r[2], designation: r[3], department: r[4], faculty_type: r[5] })),
];
...
const CURRICULUM = {
  1: [
    P(1, 'PHAR-1101', 'Anatomy & Physiology I', 'theory', 'pharmacy', 3, ['f03', 'f08', 'f17', 'f22']),
    P(1, 'PHAR-1103', 'General & Inorganic Chemistry', 'theory_lab', 'pharmacy', 4, ['f07', 'f12', 'f13', 'f24'], ['f25', 'f29']),
    P(1, 'PHAR-1105', 'Computer Fundamentals & Programming', 'theory', 'pharmacy', 3, ['f05', 'f08', 'f21']),
    P(1, 'ENG-1121', 'English Language & Communication', 'theory', 'ged', 3, ['f35', 'f36', 'f38'], null, 'ged'),
    P(1, 'MAT-1131', 'Basic Mathematics', 'theory', 'ged', 3, ['f37', 'f35'], null, 'ged'),
    P(1, 'AGR-1101', 'Fundamentals of Agriculture', 'theory', 'agriculture', 3, ['f40', 'f41'], null, 'ext'),
  ],
  2: [
    P(2, 'PHAR-1201', 'Anatomy & Physiology II', 'theory', 'pharmacy', 3, ['f03', 'f08', 'f15']),
    P(2, 'PHAR-1203', 'Organic Chemistry', 'theory_lab', 'pharmacy', 4, ['f09', 'f12', 'f13', 'f18'], ['f26', 'f30']),
    P(2, 'PHAR-1205', 'Biochemistry I', 'theory_lab', 'pharmacy', 4, ['f04', 'f11', 'f01', 'f20'], ['f27', 'f31']),
    P(2, 'PHAR-1207', 'Pharmaceutical Statistics', 'theory', 'pharmacy', 3, ['f05', 'f07', 'f23']),
    P(2, 'BAN-1221', 'Bangla Language & Literature', 'theory', 'ged', 2, ['f36', 'f35'], null, 'ged'),
    P(2, 'NFE-1203', 'Life Skills & Community Development', 'theory', 'nfe', 3, ['f39'], null, 'ext'),
  ],
  3: [
    P(3, 'PHAR-2301', 'Pharmaceutical Microbiology', 'theory_lab', 'pharmacy', 4, ['f03', 'f12', 'f19', 'f22'], ['f28', 'f32']),
    P(3, 'PHAR-2303', 'Pharmaceutics I (Dosage Forms)', 'theory_lab', 'pharmacy', 4, ['f06', 'f02', 'f10', 'f16'], ['f25', 'f26']),
    P(3, 'PHAR-2305', 'Biochemistry II', 'theory', 'pharmacy', 3, ['f04', 'f11', 'f20']),
    P(3, 'PHAR-2307', 'Pathophysiology', 'theory', 'pharmacy', 3, ['f01', 'f02', 'f14']),
    P(3, 'STA-2321', 'Statistics & Research Methods', 'theory', 'ged', 3, ['f37', 'f38'], null, 'ged'),
    P(3, 'NFE-2301', 'Ethics & Moral Development', 'theory', 'nfe', 2, ['f39'], null, 'ext'),
  ],
  4: [
    P(4, 'PHAR-2401', 'Pharmacology I', 'theory', 'pharmacy', 4, ['f01', 'f02', 'f10', 'f14']),
    P(4, 'PHAR-2403', 'Pharmaceutical Chemistry I', 'theory_lab', 'pharmacy', 4, ['f09', 'f12', 'f07', 'f13'], ['f27', 'f28']),
    P(4, 'PHAR-2405', 'Physical Pharmacy', 'theory_lab', 'pharmacy', 4, ['f06', 'f05', 'f02', 'f23'], ['f25', 'f30']),
    P(4, 'PHAR-2407', 'Pharmacognosy I', 'theory_lab', 'pharmacy', 4, ['f04', 'f11', 'f03', 'f15'], ['f26', 'f31']),
    P(4, 'PHAR-2409', 'Pharmaceutical Microbiology (Practical)', 'lab', 'pharmacy', 1, ['f12', 'f03'], ['f28', 'f32']),
    P(4, 'GED-2421', 'Business Communication', 'theory', 'ged', 3, ['f35', 'f36'], null, 'ged'),
    P(4, 'PHAR-2411', 'Recent Advances in Drug Discovery', 'theory', 'pharmacy', 2, ['f33'], null, 'pharma', 'guest'),
  ],
  5: [
    P(5, 'PHAR-3501', 'Pharmacology II', 'theory', 'pharmacy', 4, ['f02', 'f01', 'f10', 'f19']),
    P(5, 'PHAR-3503', 'Pharmaceutical Chemistry II', 'theory_lab', 'pharmacy', 4, ['f12', 'f09', 'f18', 'f24'], ['f29', 'f32']),
    P(5, 'PHAR-3505', 'Biopharmaceutics & Pharmacokinetics', 'theory', 'pharmacy', 3, ['f05', 'f06', 'f21']),
    P(5, 'PHAR-3507', 'Phytochemistry', 'theory_lab', 'pharmacy', 4, ['f04', 'f11', 'f15', 'f22'], ['f26', 'f30']),
    P(5, 'PHAR-3509', 'Pharmacology (Practical)', 'lab', 'pharmacy', 1, ['f01', 'f02'], ['f25', 'f31']),
    P(5, 'GED-3521', 'Sociology & Public Health', 'theory', 'ged', 3, ['f36', 'f38'], null, 'ged'),
    P(5, 'AGR-3501', 'Medicinal Plants & Agriculture', 'theory', 'agriculture', 2, ['f40', 'f41'], null, 'ext'),
  ],
  6: [
    P(6, 'PHAR-3601', 'Medicinal Chemistry', 'theory', 'pharmacy', 4, ['f09', 'f12', 'f13']),
    P(6, 'PHAR-3603', 'Pharmaceutical Analysis', 'theory_lab', 'pharmacy', 4, ['f07', 'f05', 'f09', 'f23'], ['f27', 'f28']),
    P(6, 'PHAR-3605', 'Clinical Pharmacy I', 'theory', 'pharmacy', 3, ['f01', 'f10', 'f16']),
    P(6, 'PHAR-3607', 'Pharmaceutical Technology', 'theory_lab', 'pharmacy', 4, ['f06', 'f02', 'f19', 'f14'], ['f25', 'f26']),
    P(6, 'PHAR-3609', 'Instrumental Analysis (Practical)', 'lab', 'pharmacy', 1, ['f07', 'f12'], ['f29', 'f30']),
    P(6, 'GED-3621', 'Entrepreneurship & Innovation', 'theory', 'ged', 3, ['f37', 'f35'], null, 'ged'),
  ],
  7: [
    P(7, 'PHAR-4701', 'Clinical Pharmacy II & Hospital Pharmacy', 'theory', 'pharmacy', 3, ['f10', 'f01', 'f16']),
    P(7, 'PHAR-4703', 'Pharmaceutical Biotechnology', 'theory_lab', 'pharmacy', 4, ['f12', 'f03', 'f20', 'f24'], ['f31', 'f32']),
    P(7, 'PHAR-4705', 'Pharmacy Practice & Pharmacy Law', 'theory', 'pharmacy', 3, ['f02', 'f11', 'f21']),
    P(7, 'PHAR-4707', 'Industrial Pharmacy', 'theory_lab', 'pharmacy', 4, ['f06', 'f05', 'f19', 'f14'], ['f26', 'f28']),
    P(7, 'PHAR-4709', 'Hospital Pharmacy (Practical)', 'lab', 'pharmacy', 1, ['f10', 'f02'], ['f25', 'f27']),
    P(7, 'PHAR-4711', 'Pharmacovigilance & Regulatory Affairs', 'theory', 'pharmacy', 2, ['f33', 'f34'], null, 'pharma', 'guest'),
  ],
  8: [
    P(8, 'PHAR-4801', 'Pharmaceutical Management & Marketing', 'theory', 'pharmacy', 3, ['f02', 'f11', 'f17']),
    P(8, 'PHAR-4803', 'Advanced Drug Delivery Systems', 'theory', 'pharmacy', 3, ['f06', 'f05', 'f13']),
    P(8, 'PHAR-4805', 'Biostatistics & Research Methodology', 'theory', 'pharmacy', 3, ['f07', 'f12', 'f24']),
    P(8, 'PHAR-4807', 'Drug Design & Development', 'theory_lab', 'pharmacy', 4, ['f09', 'f04', 'f18', 'f15'], ['f30', 'f32']),
    P(8, 'PHAR-4809', 'Industrial Training & Professional Practice', 'theory', 'pharmacy', 3, ['f33', 'f02'], null, 'pharma', 'guest'),
    P(8, 'GED-4821', 'Ethics & Professional Conduct', 'theory', 'ged', 2, ['f36', 'f35'], null, 'ged'),
  ],
};
...
const db = {
  ...
  announcements: [
    ...
    { id: 'a2', title: 'Batch 34 Pharmacology Lab rescheduled', category: 'urgent', semester_id: SEMESTER.id, batch_id: 'b34', body: 'The Pharmacology I laboratory session for Batch 34 Section A, Group A1 on Wednesday is cancelled this week. A replacement session will be announced shortly. Section B groups remain unchanged.', pinned: false, is_active: true, created_by: null, created_by_name: 'Dr. Sharmin Rahman', created_at: '2026-08-26T10:00:00Z' },
    { id: 'a3', title: 'Guest lecture: Pharmacovigilance in Bangladesh', category: 'event', semester_id: SEMESTER.id, batch_id: 'b29', body: 'A guest lecture on "Pharmacovigilance in Bangladesh" by Dr. Abdul Karim Mahmud will be held for Batch 29 in the Seminar Hall, AB-501. Attendance is mandatory.', pinned: false, is_active: true, created_by: null, created_by_name: 'Dept. of Pharmacy', created_at: '2026-08-24T14:00:00Z' },
