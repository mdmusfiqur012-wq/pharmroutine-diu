...
const db = {
  ...
  announcements: [
    ...
    { id: 'a3', title: 'Guest lecture: Pharmacovigilance in Bangladesh', category: 'event', semester_id: SEMESTER.id, batch_id: 'b29', body: 'A guest lecture on "Pharmacovigilance in Bangladesh" by Prof. Dr. Muniruddin Ahamed will be held for Batch 29 in Classroom AB-1 504. Attendance is mandatory.', pinned: false, is_active: true, created_by: null, created_by_name: 'Dept. of Pharmacy', created_at: '2026-08-24T14:00:00Z' },
